                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                <a
                                    ...
                                    id="docs-card"
                                    className="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-card p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-border transition duration-300 hover:text-foreground hover:ring-border focus:outline-none focus-visible:ring-primary md:row-span-3 lg:p-10 lg:pb-10"
                                >
                                    <div
                                ...
                                <a
                                    ...
                                    className="flex items-start gap-4 rounded-lg bg-card p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-border transition duration-300 hover:text-foreground hover:ring-border focus:outline-none focus-visible:ring-primary lg:pb-10"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-card p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-border lg:pb-10">
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                            xmlns="http://www.w3.org/2000/svg"
